...
adds three filing-ready drafts (upstream MCP spec PR, arXiv
preprint, v0.9 leaderboard design) that move the project off the
"closed-source nothing-shipped" baseline the petition reviewers
flagged in §F-§G.
...
- **`docs/spec/proposal/v09-leaderboard.md`** — v0.9 leaderboard
  ...
  Filing checklist gates implementation on attorney privacy
